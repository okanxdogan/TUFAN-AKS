...
E22_ADDL = 0x00
E22_NETID = 0x00
# CRYPT ortak anahtari (G7 heartbeat-injection kapatma) UKS sozlesmesiyle
# birebir 0x5A3C. AKS E22Regs.h (E22_CFG_CRYPT_H/L) ve UKS e22_regs.h
# (E22_VAL_CRYPT_H/L) ile AYNI COMMIT'te senkron kalmali (drift-guard:
# test_e22_register_targets_match_across_repos).
E22_CRYPT_H = 0x5A
E22_CRYPT_L = 0x3C
