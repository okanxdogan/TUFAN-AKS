...
void test_contract_regs_match_ortak_blok(void) {
    ...
    TEST_ASSERT_EQUAL_HEX8(0x62, E22_CONTRACT_REGS.reg0);
...
void test_build_write_command(void) {
    ...
    TEST_ASSERT_EQUAL_HEX8(0x62, buf[6]);  // REG0
...
void test_parse_valid_response_accepted(void) {
    const uint8_t resp[12] = {
        0xC1, 0x00, 0x09,
        0x00, 0x00, 0x00, 0x62, 0x00, 0x17, 0x00,  // ADDH..REG3
...
void test_is_error_response_false_for_valid(void) {
    const uint8_t resp[12] = {
        0xC1, 0x00, 0x09,
        0x00, 0x00, 0x00, 0x62, 0x00, 0x17, 0x00,
        0x00, 0x00,
    };
