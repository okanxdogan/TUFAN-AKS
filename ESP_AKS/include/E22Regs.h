...
// CRYPT: yazılır ama E22'de geri OKUNAMAZ (okuma her zaman 0 döner) —
// doğrulama karşılaştırmasından CRYPT HARİÇ tutulur (bkz. E22Config::e22_regsEqual).
#define E22_CFG_CRYPT_H 0x00U
#define E22_CFG_CRYPT_L 0x00U
